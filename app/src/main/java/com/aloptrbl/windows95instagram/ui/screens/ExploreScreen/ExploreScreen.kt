package com.aloptrbl.windows95instagram.ui.screens.ExploreScreen
    ...
    Column(
        ...
        WinBox(
            ...
            Row(verticalAlignment = Alignment.CenterVertically,  horizontalArrangement = Arrangement.SpaceBetween,modifier = Modifier.fillMaxSize()) {
                Row() {
                    Text(text ="Explore", fontSize = 20.sp, fontWeight = FontWeight.Bold ,modifier = Modifier.padding(horizontal = 10.dp))
                }
                Row() {
        ...
        WinBox(modifier = Modifier
            .padding(3.dp, 5.dp)
            .fillMaxSize()) {
            PostGrid(posts = items.value, navController = navController)
        }
    }
}